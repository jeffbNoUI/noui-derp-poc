...
func (h *Handlers) GetContributionHistory(w http.ResponseWriter, r *http.Request) {
	...
	if member == nil {
		WriteError(w, r, http.StatusNotFound, "MEMBER_NOT_FOUND", "No member found with ID "+memberID)
		return
	}
	...
	if err != nil {
		...
		WriteError(w, r, http.StatusInternalServerError, "INTERNAL_ERROR", "Failed to retrieve contribution ledger")
		return
	}
	...
	if err != nil {
		...
		WriteError(w, r, http.StatusInternalServerError, "INTERNAL_ERROR", "Failed to retrieve interest credits")
		return
	}
...
func (h *Handlers) GetRefundApplication(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		WriteError(w, r, http.StatusInternalServerError, "INTERNAL_ERROR", "Failed to retrieve refund application")
		return
	}
...
func (h *Handlers) SaveRefundApplication(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		WriteError(w, r, http.StatusInternalServerError, "INTERNAL_ERROR", "Failed to save refund application: "+err.Error())
		return
	}
