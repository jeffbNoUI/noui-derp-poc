  ...
  return (
    <div data-print="benefit-statement" style={S.page}>
      ...
      <div style={S.section}>
        ...
        <Row label="Tier" value={tierLabel} T={T} />
      ...
      {(ben.ipr || ben.death_benefit) && (
        <div style={S.section}>
          <div style={S.sectionTitle}>Supplemental Benefits</div>
          {ben.ipr && (
            <>
              <Row label="IPR (pre-Medicare)" value={`${fmt(ben.ipr.monthly_amount)}/mo`} T={T} />
              <Row label="IPR (post-Medicare)" value={`${fmt(ben.ipr.monthly_amount / 2)}/mo`} T={T} />
            </>
          )}
          {ben.death_benefit && (
      ...
      <div style={S.disclaimer}>
        ...
        in effect, your actual salary history, and your service credit on file. Contact DERP at
        (303) 839-5419 for questions.
      </div>
      ...
      <div style={{
        ...
        Denver Employees Retirement Plan · 777 Pearl Street · Denver, CO 80203
        <br />
